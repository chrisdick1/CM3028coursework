...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
       ...
       ?>
         ...
         <div class="col-lm-3 col-md-6 col-sm-6" >
...
<?php if ((isset($_SESSION['userSession'])) && ($_SESSION['permissions'] == 3)) { ?>
    <button type="button" class="btn btn-info-pull-right btn-lg btn-pull-right" data-toggle="modal" data-target="#myModal">Add Club
    </button>
<?php } ?>
<!-- Modal -->
